  ...
  return (
    <div className="space-y-8">
      <div className="bg-white rounded-xl shadow-md p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Youth Unemployment Crisis</h2>
        
        <div className="mb-8">
          <Bar data={youthData} options={options} />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-red-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-red-800 mb-2">Highest Affected Group</h3>
            <p className="text-2xl font-bold">21-25 year olds</p>
            <p className="text-sm text-gray-600">24.7% unemployment rate</p>
          </div>
          
          <div className="bg-purple-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-purple-800 mb-2">Recent Graduates</h3>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-xl font-semibold mb-4">Consequences of Youth Unemployment</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-medium text-red-700 mb-2">Economic Impact</h4>
          ...
          <div>
            <h4 className="font-medium text-red-700 mb-2">Social Impact</h4>
            <ul className="list-disc list-inside text-gray-700 space-y-1">
